...
public class RecordDaabaseHelper extends SQLiteOpenHelper
{
    ...
    public RecordDaabaseHelper(Context context, String name,  SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void eidtRecord(String uuid,RecordBean record){
        removeRecord(uuid);
        record.setUuid(uuid);
        addRecord(record);
    }
